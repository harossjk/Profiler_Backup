...
{
    [Serializable]
    public partial class UCChannelConfig : UserControl
    {
        ...
        private void InitEvent()
        {
            ...
            this.cmbRStationType.SelectedIndexChanged += this.cmbRStationType_SelectedIndexChanged;
        ...
        public void GetConfig(CDDEAConfigMS_V4 cConfig)
        {
            try
            {
        ...
        public CDDEAConfigMS_V4 SetConfig(CDDEAConfigMS_V4 cConfig)
        {
            if (cConfig == null)
                cConfig = new CDDEAConfigMS_V4();
        ...
        private void cmbRStationType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                EMStationTypeMS stationType = this.m_cTypeConvert.GetStationType(this.cmbRStationType.SelectedItem.ToString());
                StationTypeSelected(stationType);
        ...
        private void CmbRProtocolType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.cmbRStationType.SelectedItem != null)
            {
                StationTypeSelected(this.m_cTypeConvert.GetStationType(this.cmbRStationType.SelectedItem.ToString()));
            }
