...
namespace UDM.DDEA
{
    public partial class UCChannelTest : XtraUserControl
    {
                ...
                if (numArray4 == null)
                {
                    if (m_cReadFunction.ReadErrorCode != 0x1801001)
                    {
                        ...
                        foreach (var item in lstAddress)
                            txtTimeLog.AppendText("Send Address : " + item + "\r\n");
        ...
        private void btnStartManulTest_Click(object sender, EventArgs e)
        {
            try
            {
                if (m_bRunChannelTest)
