...
// Type: UDMProfilerV3.FrmVerticalLogicChart
...
{
  public class FrmVerticalLogicChart : XtraForm
  {
    ...
    private UCVerticalTimeChartControl ucVerticalTimeChartControl;
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (FrmVerticalLogicChart));
      this.grpTimeChart = new GroupControl();
      this.ucVerticalTimeChartControl = new UCVerticalTimeChartControl();
      ...
      this.ucVerticalTimeChartControl.ContextMenuStripForSeriesChart = (ContextMenuStrip) null;
      ...
      this.ucVerticalTimeChartControl.IsEditable = false;
      ...
      this.ucVerticalTimeChartControl.TabIndex = 22;
      ...
      this.exBarManager.MaxItemId = 43;
      ...
      this.Name = "FrmVerticalLogicChart";
      this.Text = "다중 로직 차트";
      this.Load += new EventHandler(this.FrmVerticalLogicChart_Load);
    ...
    public FrmVerticalLogicChart(DataTable fileTable, string mode)
    {
    ...
    private void ucVerticalTimeChartControl_UEventGanttTreeZoomed(float nUpDownRatio, float nLRRatio)
    {
    ...
    {
      if (this.m_sMode == "I")
        this.ucVerticalTimeChartControl.ClearGanttItemsByIntegMode(sProjName);
      else
        this.ucVerticalTimeChartControl.RemoveTreeChartUI(sProjName);
      if (this.ucMultiStepTagTable.ProjectS.Count == 1)
    ...
    {
      if (this.m_cSelectedBar == null)
      {
        int num = (int) CMessageHelper.ShowPopup("기준 Bar를 선택해 주세요.", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
      }
      else
        this.ResetTime(this.m_cSelectedBar.StartTime, this.ucVerticalTimeChartControl.SelectedItem.Facility);
    }
    ...
    private void DrawIntegratioMode(List<CMainControl_V4> lstProject, List<CLogHistoryInfo> lstHistory)
    {
      ...
      if (!this.m_bIsAlreadyDrawIntegrate)
      {
        ...
        this.RegisterGanttTreeEvent(gTv);
    ...
    private void DrawPartitionMode(List<CMainControl_V4> lstProject, List<CLogHistoryInfo> lstHistory)
    {
      ...
      if (lstProject.Count == 1)
      {
        ...
        UCGanttTreeContextMenuStrip gTv = new UCGanttTreeContextMenuStrip(false);
        this.RegisterGanttTreeEvent(gTv);
        ucGanttTree.ContextMenuStrip = gTv.ContextMenu;
