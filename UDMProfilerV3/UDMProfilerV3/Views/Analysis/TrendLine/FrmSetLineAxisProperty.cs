...
{
    public partial class FrmSetLineAxisProeprty : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmSetLineAxisProeprty(CTrendLineViewAxisProeprties cViewProp)
        {
            InitializeComponent();
            InitView(cViewProp);
            ...
            this.KeyUp += FrmSetLineAxisProeprty_KeyUp;
        }
        ...
        public void SetTextLanguage()
        {
            ...
            this.labelControl2.Text = ResLanguage.FrmSetLineAxisProeprty_Range;
        ...
        private void InitView(CTrendLineViewAxisProeprties cViewProp)
        {
            ...
            txtXStartTime.EditValue = cViewProp.XAxisStartTime.ToString("HH:mm:ss");
            txtXEndTime.EditValue = cViewProp.XAxisEndTime.ToString("HH:mm:ss");
            txtXAxisSacle.EditValue = cViewProp.XAxisScale;

            txtYStartValue.EditValue = cViewProp.YAxisStartValue;
            txtYEndValue.EditValue = cViewProp.YAxisEndValue;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (UEventTrendLineSetAxisProp != null)
            {
                ...
                cProp.XAxisStartTime = Convert.ToDateTime(txtXStartTime.EditValue);
                cProp.XAxisEndTime = Convert.ToDateTime(txtXEndTime.EditValue);
                cProp.XAxisScale = Convert.ToInt32( txtXAxisSacle.EditValue);
                cProp.YAxisStartValue = Convert.ToDouble(txtYStartValue.EditValue);
                cProp.YAxisEndValue = Convert.ToDouble(txtYEndValue.EditValue);
        ...
        private void FrmSetLineAxisProeprty_KeyUp(object sender, KeyEventArgs e)
        {
